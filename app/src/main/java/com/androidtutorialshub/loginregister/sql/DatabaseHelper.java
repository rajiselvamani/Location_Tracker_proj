...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private String CREATE_USER_TABLE = "CREATE TABLE " + TABLE_USER + "("
            ...
            + COLUMN_USER_EMAIL + " TEXT," + COLUMN_USER_PASSWORD + " TEXT," +COLUMN_USER_LATITUDE + " TEXT," + COLUMN_USER_LONGITUDE + " TEXT" + ")";
    ...
    public List<User> getAllUser() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                user.setLatitude(cursor.getString(cursor.getColumnIndex(COLUMN_USER_LATITUDE)));
                user.setLongitude(cursor.getString(cursor.getColumnIndex(COLUMN_USER_LONGITUDE)));
    ...
    public User search_by_email(String email)
    {
        // array of columns to fetch
        String[] columns = {
                COLUMN_USER_ID,
