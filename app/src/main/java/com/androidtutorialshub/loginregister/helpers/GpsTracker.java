...
public class GpsTracker extends Service implements LocationListener {
    ...
    public static boolean is_location_enabled;
    ...
    /**
     * Function to get loaction
     * this function will get latitude and longitude with GPS location
     * */
    ...
    /**
     * Function to get location enabled status
     * on calling function it will return boolean status
     * */
    public boolean isLocationEnabled(Context context) {
        ...
        is_location_enabled=(gps_enabled&&network_enabled);
